...
namespace Entity
{
    public class RegimenContributivo : LiquidacionCuotaModeradora
    {
        ...
        public RegimenContributivo(string numeroLiquidacion, DateTime fecha, string identificacionPaciente, string tipo, decimal salarioPaciente, decimal valorServicio) : base(numeroLiquidacion, fecha, identificacionPaciente, tipo, salarioPaciente, valorServicio)
        {
        }
